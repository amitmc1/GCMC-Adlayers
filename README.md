<div style="border: 2px solid #000; padding: 10px; margin-bottom: 20px;">
  ...
  <p align="center">
    This repository contains data from the publication (under review): <em>Ab initio</em> insights into support-induced sulfur resistance in Ni-based reforming catalysts. All output files from Monte Carlo sampling and input/output files for MACE fine-tuning and inferencing have been uploaded to Figshare at the DOI: https://doi.org/10.6084/m9.figshare.29562377 
  </p>
  <p align="center">
